...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
   ...
   <div class="flex justify-between items-center mb-8">
      <div>
         <h1 class="text-3xl font-bold text-gray-900">Tambah Profile Perusahaan</h1>
         <p class="text-gray-600 mt-2">Buat profile perusahaan baru untuk ditampilkan di website</p>
      </div>
   ...
   <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      <div class="px-6 py-4 border-b border-gray-200">
         <h3 class="text-lg font-semibold text-gray-900">Form Profile Perusahaan</h3>
      </div>

      <div class="p-6">
         <?= form_open('admin/profile/tambah', ['class' => 'space-y-6']) ?>
                  ...
                  <div class="space-y-4">
                     ...
                     <div>
                        ...
                        <input type="number"
                           ...
                           value="<?= set_value('tahun_berdiri', '2020') ?>"
                     ...
                     <div class="grid grid-cols-2 gap-4">
                        <div>
                           ...
                           <input type="number"
                              ...
                              value="<?= set_value('jumlah_klien', '500') ?>"
                              min="0" required>
                        ...
                        <div>
                           ...
                           <input type="number"
                              ...
                              value="<?= set_value('jumlah_proyek', '1000') ?>"
                              min="0" required>
                  ...
                  <div class="space-y-4">
                     <div>
                        ...
                        <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-dark focus:border-secom-blue-dark transition-colors duration-200"
                           ...
                           placeholder="Masukkan alamat perusahaan"><?= set_value('alamat') ?></textarea>
                     </div>
               ...
               <div class="space-y-4">
                  <div>
                     ...
                     <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-dark focus:border-secom-blue-dark transition-colors duration-200 <?= form_error('deskripsi') ? 'border-red-500' : '' ?>"
                        ...
                        placeholder="Jelaskan tentang perusahaan, layanan, dan keunggulan" required><?= set_value('deskripsi') ?></textarea>
                  ...
                  <div>
                     ...
                     <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-dark focus:border-secom-blue-dark transition-colors duration-200 <?= form_error('visi') ? 'border-red-500' : '' ?>"
                        ...
                        placeholder="Masukkan visi perusahaan" required><?= set_value('visi') ?></textarea>
                  ...
                  <div>
                     ...
                     <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-dark focus:border-secom-blue-dark transition-colors duration-200 <?= form_error('misi') ? 'border-red-500' : '' ?>"
                        ...
                        placeholder="Masukkan misi perusahaan" required><?= set_value('misi') ?></textarea>
