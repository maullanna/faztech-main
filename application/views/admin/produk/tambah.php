    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h3 class="text-xl font-semibold text-gray-800">Tambah Paket Baru</h3>
        ...
        <div class="p-6">
            <?= form_open_multipart('admin/produk/tambah', ['class' => 'space-y-6']) ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="kategori" name="kategori"
                        ...
                        <option value="CCTV" <?= set_select('kategori', 'CCTV') ?>>CCTV</option>
                        <option value="Access Control" <?= set_select('kategori', 'Access Control') ?>>Access Control</option>
                        <option value="Barrier Gate" <?= set_select('kategori', 'Barrier Gate') ?>>Barrier Gate</option>
                        <option value="Internet Dedicated" <?= set_select('kategori', 'Internet Dedicated') ?>>Internet Dedicated</option>
                        <option value="Smart Solution" <?= set_select('kategori', 'Smart Solution') ?>>Smart Solution</option>
                        <option value="Gallery" <?= set_select('kategori', 'Gallery') ?>>Gallery</option>
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="kualitas" name="kualitas"
                            ...
                            value="<?= set_value('kualitas', 'Kualitas Premium') ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="garansi" name="garansi"
                            ...
                            value="<?= set_value('garansi', 'Garansi Resmi') ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="instalasi" name="instalasi"
                            ...
                            value="<?= set_value('instalasi', 'Instalasi Gratis') ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="support" name="support"
                            ...
                            value="<?= set_value('support', 'Support 24/7') ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="fitur_tambahan" name="fitur_tambahan"
                            ...
                            value="<?= set_value('fitur_tambahan') ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" id="is_promo" name="is_promo" value="1" class="mr-2 rounded border-gray-300 text-secom-blue-dark focus:ring-secom-blue-light" onchange="togglePromoFields()">
                    ...
                    <div>
                        ...
                        <input type="text" id="promo_label" name="promo_label"
                            ...
                            value="<?= set_value('promo_label', 'Promo Spesial') ?>">
                        <p class="text-xs text-gray-500 mt-1">Contoh: Promo Spesial, Diskon 50%, dll</p>
                    </div>
                </div>

                <div id="promo_price_fields" class="hidden mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secom-blue-light focus:border-transparent outline-none"
                    placeholder="Masukkan deskripsi paket" required><?= set_value('deskripsi') ?></textarea>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Upload gambar untuk paket ini (opsional)</p>
            </div>
